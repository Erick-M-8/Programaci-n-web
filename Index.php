    ...
    <div class="container">
                ...
                <?php for ($i = 0; $i < count($datos); $i++): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Editar.php?id=<?php echo $datos[$i][0] ?>">Editar</a>
                            <br>


                            <a href="#" onclick="peticion('Delete.php?id=<?php echo $datos[$i][0] ?>'); return false;">Eliminar</a>
                        </td>
                    </tr>
                <?php endfor ?>
            </tbody>
        ...
        <div class="d-flex justify-content-center">
            <div class="btn-group btn-group-lg">
                ...
                <a href="Generar_PDF_V.php" class="btn btn-primary">Generar PDF</a>
            </div>
        </div>
</div>
