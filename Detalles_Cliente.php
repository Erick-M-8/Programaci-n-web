<?php
    ...
    if(isset($_GET["id"])) {
        ...
        if($reg = mysqli_fetch_row($cursor)) {
            ...
            echo "<br><img src='data:image/jpg;base64," . base64_encode($reg[9]) . 
            "' alt='*Por Favor Agregue una Imagen*' class='img-detalles'><br>";
            echo "PLATAFORMA: $reg[2]<br>";
            echo "AÑO: $reg[3]<br>";
            echo "IDIOMA: $reg[4]<br>";
            echo "GENERO: $reg[5]<br>";
            echo "PRECIO: $reg[6]<br>";
            echo "<iframe width='460' height='315' src='" . $reg[8] . "' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
